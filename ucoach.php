...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Perform the SQL query to update data in the 'coach' table
    $sql = "UPDATE coach SET coachname = '$coachname', coach_age = '$coach_age', coach_type = '$coach_type', team_id = '$team_id', experience_in_years = '$experience_in_years' WHERE coach_id = '$coach_id'";
